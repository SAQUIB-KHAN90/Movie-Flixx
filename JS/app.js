const global = { 
 ...
 api : {
  API_KEY :  '9ea767cab42b3996e7eaffb17907a501',
   API_URL : 'https://api.themoviedb.org/3/'
 }
};
//DISPLAY 20 POPULAR MOVIES
async function displayPopMovie(){
      ...
      function displayBackgroundImage(type,backgroundPath){
        ...
        async function search (){
            ...
            if(global.search.term !== '' & global.search.term !== null){
                ...
                global.search.totatResults = total_results
        ...
        function displaySearchResults(results) {
          ...
          results.forEach((result) => {
            ...
            div.innerHTML = `
                ...
                `;
                document.querySelector('#search-results-heading').innerHTML = `<h2>${results.length} of ${global.search.totatResults}
...
// show Error Alert
function showAlert(message , className = 'erroe'){
